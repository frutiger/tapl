...
def parse_concrete(tokens):
    ...
    parser = lrparser.LRParser(acceptance, shifts, reductions, gotos)
    return parser.parse(tokens)

def parse(tokens):
    return terms.from_concrete(parse_concrete(tokens))
